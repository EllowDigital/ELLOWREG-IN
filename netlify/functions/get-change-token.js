...
exports.handler = async (event) => {
    ...
    try {
      ...
      FROM registrations;`;
        ...
        const lastCreatedISO = row.last_created ? new Date(row.last_created).toISOString() : "";
        const lastCheckinISO = row.last_checkin ? new Date(row.last_checkin).toISOString() : "";
        const lastUpdateISO = hasUpdatedAt && row.last_update
        ...
        const lastActivityISO = timeCandidates
